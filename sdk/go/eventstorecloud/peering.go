...
func (i *Peering) ToPeeringPtrOutput() PeeringPtrOutput {
	return i.ToPeeringPtrOutputWithContext(context.Background())
}

func (i *Peering) ToPeeringPtrOutputWithContext(ctx context.Context) PeeringPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PeeringPtrOutput)
}

type PeeringPtrInput interface {
	pulumi.Input

	ToPeeringPtrOutput() PeeringPtrOutput
	ToPeeringPtrOutputWithContext(ctx context.Context) PeeringPtrOutput
}

type peeringPtrType PeeringArgs

func (*peeringPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**Peering)(nil))
}

func (i *peeringPtrType) ToPeeringPtrOutput() PeeringPtrOutput {
	return i.ToPeeringPtrOutputWithContext(context.Background())
}

func (i *peeringPtrType) ToPeeringPtrOutputWithContext(ctx context.Context) PeeringPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PeeringPtrOutput)
}
...
func (o PeeringOutput) ToPeeringPtrOutput() PeeringPtrOutput {
	return o.ToPeeringPtrOutputWithContext(context.Background())
}
...
func (o PeeringPtrOutput) ToPeeringPtrOutput() PeeringPtrOutput {
	return o
}
...
func init() {
	...
	pulumi.RegisterOutputType(PeeringPtrOutput{})
