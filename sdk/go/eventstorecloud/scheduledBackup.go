...
func (i *ScheduledBackup) ToScheduledBackupPtrOutput() ScheduledBackupPtrOutput {
	return i.ToScheduledBackupPtrOutputWithContext(context.Background())
}

func (i *ScheduledBackup) ToScheduledBackupPtrOutputWithContext(ctx context.Context) ScheduledBackupPtrOutput {
...
type ScheduledBackupPtrInput interface {
	...
	ToScheduledBackupPtrOutputWithContext(ctx context.Context) ScheduledBackupPtrOutput
}
